...
interface LongFlightPathProps {
  className?: string;
}

const LongFlightPath: React.FC<LongFlightPathProps> = ({ className }) => {
  return (
    <div className={`flex items-center justify-center ${className}`}>
      ...
      {/* Middle dots */}
      <div className="w-1 h-0.5 ml-1 bg-[#363635]" />
	  <div className="w-1 h-0.5 ml-1 bg-[#363635]" />
	  <div className="w-1 h-0.5 ml-1 bg-[#363635]" />
      <div className="w-1 h-0.5 ml-1 bg-[#363635]" />
      <div className="w-1 h-0.5 mx-1 bg-[#363635]" />
      ...
      {/* Right dots */}
      <div className="w-1 h-0.5 mx-1 bg-[#363635]" />
      <div className="w-1 h-0.5 mr-1 bg-[#363635]" />
	  <div className="w-1 h-0.5 mr-1 bg-[#363635]" />
	  <div className="w-1 h-0.5 mr-1 bg-[#363635]" />
	  <div className="w-1 h-0.5 mr-1 bg-[#363635]" />
