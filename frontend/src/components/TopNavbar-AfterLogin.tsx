  ...
  return (
    <div className={`bg-white shadow px-[80px] p-4 flex items-center justify-between ${className}`}>
      ...
      <div className="px-4 py-1 rounded-[8px] flex items-center justify-between">
        <button className="mt-0 font-bold text-black">Purchase</button>
        <button className="mt-0 ml-[20px] font-bold text-black">Bookings</button>
...
export default TopLoginAfterNavbar;
