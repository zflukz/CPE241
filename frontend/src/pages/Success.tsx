  ...
  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-[100px] w-full ">
    <div className="text-black px-4 py-2 rounded-md flex flex-col items-center text-center">
      ...
      <label className="bg-gray-100 mt-[30px] rounded-xl shadow p-4  items-center  w-1/3 h-auto opacity-70">
          <span className="block"> A confirmation email has been sent to : yourmail@gmail.com </span> 
      ...
      <div className="flex gap-10 mt-12 ">
        ...
        <button className="bg-white hover:bg-orange-700 text-black hover:text-white hover:outline-none px-12 py-[5px] rounded-lg outline outline-2 outline-offset-2 outline-orange-500">Back to Home</button>
      </div>
    </div>
  </div>
</div>
